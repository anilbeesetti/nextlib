...
ANDROID_PLATFORM=21
ENABLED_DECODERS="vorbis opus flac alac pcm_mulaw pcm_alaw mp3 amrnb amrwb aac ac3 eac3 dca iamf mlp mpegh truehd h264 hevc mpeg2video mpegvideo libvpx_vp8 libvpx_vp9"
